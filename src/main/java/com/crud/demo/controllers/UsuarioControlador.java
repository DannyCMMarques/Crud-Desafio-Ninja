...
public class UsuarioControlador {
        ...
        public ResponseEntity<RegistroUsuarioDTO> cadastrarUsuario(@RequestBody RegistroUsuarioDTO usuarioDTO) {
                RegistroUsuarioDTO saved = usuarioService.cadastrarUsuario(usuarioDTO);
        ...
        public ResponseEntity<RegistroUsuarioDTO> buscarUsuarioPorId(@PathVariable Long id) {
                RegistroUsuarioDTO usuarioDTO = usuarioService.buscarUsuarioPorId(id);
        ...
        public ResponseEntity<RegistroUsuarioDTO> atualizarUsuario(@PathVariable Long id,
                        @RequestBody RegistroUsuarioDTO usuarioDTO) {
                RegistroUsuarioDTO usuarioAtualizado = usuarioService.atualizarUsuario(id, usuarioDTO);
        ...
        public ResponseEntity<Page<RegistroUsuarioDTO>> exibirTodosUsuarios(
                ...
                Page<RegistroUsuarioDTO> usuarios = usuarioService.exibirTodosUsuarios(pageable);
