...
public class ChakrasServiceImpl implements ChakrasService {
    ...
    @Override
    public void verificarChakra(EstatisticaDoJogadorEvent estatisticaJogador, JutsuResponseDTO jutsuEscolhido,
        ...
        if (estatisticaJogador.getValor_chakra() > jutsuEscolhido.getConsumo_de_chakra()) {
            ...
            .mensagem("Você não possui chakra o suficiente para usar esse Jutsu")
            .build();
    ...
    public void atualizarEstatistica(AtaqueEvent ataqueEvent) {
        ...
        JutsuResponseDTO jutsuEscolhido = ataqueEvent.getJutsuAtaque();
    ...
    @Override
    public void calcularNovoChackra(Long idBatalha, EstatisticaDoJogadorEvent atacante, JutsuResponseDTO jutsuEscolhido) {
