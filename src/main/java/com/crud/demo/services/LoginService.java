...
public class LoginService {
    ...
    public LoginService(AuthenticationManager authenticationManager, UsuarioValidator usuarioValidator,
    ...
    public LoginResponseDTO gerarLoginResponse(String token) {
        ...
        return new LoginResponseDTO(token, sub, role, createdAt, exp, iat);
    }
}
